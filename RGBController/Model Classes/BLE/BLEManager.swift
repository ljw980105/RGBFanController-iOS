...
class BLEManager: NSObject {
    ...
    private var rgbController: CBPeripheral?
    private var rgbDataPoint: CBCharacteristic?
    ...
    private var bleModuleName: String = ""
    ...
    /// Initialize the `CBCentralManager` Object by referencing the singleton
    func start() {
        print("Starting BLE Manager")
    }
    
    func connect(module: String) {
        bleModuleName = module
    ...
    func disconnect() {
        if let peripheral = rgbController {
    ...
    func send(string: String) {
        guard let peripheral = rgbController, let characteristic = rgbDataPoint else {
...
extension BLEManager: CBCentralManagerDelegate {
    ...
    func centralManager(_ central: CBCentralManager,
        ...
        rgbController = peripheral
        bluetoothManager.connect(rgbController!, options: nil)
    }
    
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        print("Connected")
        rgbController?.delegate = self
        rgbController?.discoverServices([bleModuleUUID])
    }
...
extension BLEManager: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral,
        ...
        rgbController?.setNotifyValue(true, for: dataPoint)
        DispatchQueue.main.async { [weak self] in
